...
object SimpleAtnExample extends SimXApplicationMain (new SimpleAtnExample) {
...
class SimpleAtnExample extends SimXApplication with EventHandler with EventProvider {

  import SimpleAtnExample._
  ...
  protected def applicationConfiguration = ApplicationConfig withComponent
    ...
    ATNMachineAspect(atnName, new SimpleAtn, autoResetAfter = Some(10000L), drawGraphs = true)
