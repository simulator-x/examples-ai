 ...
 */
object ExtendedSubAtnExample extends SimXApplicationMain (new ExtendedSubAtnExample) {
...
class ExtendedSubAtnExample extends SimXApplication with EventHandler with EventProvider {

  import ExtendedSubAtnExample._
  ...
  protected def applicationConfiguration = ApplicationConfig withComponent
    ...
    ATNMachineAspect(atnName, new ExtendedSubAtn(), autoResetAfter = None, drawGraphs = true)
